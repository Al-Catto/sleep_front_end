...
def page_userinputs(state):
    ...
    state.age = st.text_input("what is your age?", state.age or 41)
    #st.write(state.age)
    ...
    state.education_survey1 = st.selectbox('What is your highest level of education?', options, options.index(state.education_survey1) if state.education_survey1 else 5)
    #st.write(state.education_survey1)

    #Q5: Height "heightcm"
    state.heightcm = st.text_input("what is your height in cm?", state.heightcm or 171)
    #st.write(state.heightcm)
    
    #Q6: Weight "weightkg"
    state.weightkg = st.number_input("what is your weight in kg?", state.weightkg or 64)
